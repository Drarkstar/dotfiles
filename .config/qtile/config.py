...
keys = [
    ...
    #---    Shutdown      ---#
    Key([mod, "shift"], "e", lazy.spawn("shutdown now")),
...
groups = [#Group(i) for i in [
    ...
    Group("   "), 
    Group(" 󰌠  "), 
    Group( '4 ', label="   ", matches=[Match(wm_class=["steam"])]), 
    Group("   "), 
    Group("   "), 
    Group("   ")
]
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.TextBox(randomtext(), foreground="#4af7bc"),
                widget.TextBox(
                    text='',
                    background="#232136",
                    foreground="#f6c177",
